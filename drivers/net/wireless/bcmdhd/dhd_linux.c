...
{
#if 1	 // Fujitsu 2012.04.26 WLAN/BT 12_1ST_GENERIC
...
#endif	 // Fujitsu 2012.04.26 WLAN/BT 12_1ST_GENERIC
	return 0;
}
...
// Fujitsu 2012.03.27 WLAN/BT change end
	...
	// Max 5Sec wait. polling for [sdio_pol_off_tts].
	DHD_ERROR(("%s: wait start\n", __FUNCTION__));
	while( !sdio_pol_off_tts && timeout ){
		timeout = schedule_timeout( timeout );
	}
	DHD_ERROR(("%s: wait end\n", __FUNCTION__));
