...
#define CONFIG_STK_PS_SAMPLING_RATE 5
#define CONFIG_STK_PS_ENGINEER_TUNING
#define CONFIG_STK_ALS_TRANSMITTANCE_TUNING
#define CONFIG_STK_ALS_TRANSMITTANCE 500
#define CONFIG_STK_PS_GAIN_SETTING 0x08
#define CONFIG_STK_PS_CODE_HIGH_THRESHOLD 200
#define CONFIG_STK_PS_CODE_LOW_THRESHOLD 180
