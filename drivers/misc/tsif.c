...
#define CLK_HALT_STATEB           (MSM_CLK_CTL_BASE + 0x10c)
#define TSIF_NS_REG               (MSM_CLK_CTL_BASE + 0x0c4)
#define TV_NS_REG               (MSM_CLK_CTL_BASE + 0x0cc)
#else
