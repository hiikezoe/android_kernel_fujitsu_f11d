...
#ifndef	__RADIO_MB86A30V_H__
#define	__RADIO_MB86A30V_H__
...
enum ioctl_command_no {
	...
	IOCTL_AGC_OPERATING,          /* AGC operation */
	IOCTL_LNA_SETTING,            /* LNA setting   */
	IOCTL_CMOS_SETTING,           /* CMOS setting  */
	IOCTL_AVDE_INIT,              /* AVDE init     */
	IOCTL_SEQ_SETMODE,
	IOCTL_CH_SEARCH_SETTING,
	IOCTL_CH_SEARCH_START,
	IOCTL_CH_SEARCH_STOP,
	IOCTL_CH_SEARCH_END,
	IOCTL_CH_SEARCH_RESULT,
	IOCTL_STANDBY
};
...
#define		PARAM_SEARCH_MODE2		0x01
#define		PARAM_SEARCH_MODE3		0x02
#define		PARAM_SEARCH_GUARD14		0x00
#define		PARAM_SEARCH_GUARD18		0x01
#define		PARAM_SEARCH_GUARD116		0x02
#define		PARAM_SEARCH_TMCC_OFF	0x00
#define		PARAM_SEARCH_TMCC_ON	0x01
#define		PARAM_SEARCH_TIME_15	0x52
#define		PARAM_SEARCH_TIME_31	0x56
#define		PARAM_SEARCH_TIME_63	0x5a
#define		PARAM_SEARCH_TIME_127	0x5e



// -- long (2011/08/17) --
#define		PARAM_RF_INITIALIZE	0x00
#define		PARAM_RF_INIT_SETTING	0x01

							/* RESET */
#define		PARAM_RESET_ON			0x00	/* OFDM soft reset */
#define		PARAM_RESET_OFF			0xFF	/* OFDM soft reset cancel */
#define		PARAM_LOGIC_RESET		0xF8

							/* LNA_SETTING --long (2011/08/12)-- */
#define		PARAM_LNA_INITIALIZE			0x00	/* LNA Initialize */
#define		PARAM_LNA_ON					0x01	/* LNA ON */
#define		PARAM_LNA_OFF					0x02	/* LNA OFF */
#define		PARAM_LNA_INIT_SETTING			0x03	/* LNA INIT SETTING */
#define		PARAM_LNA_AUTO_ON				0x04

// -- long (2011/08/18) --
#define		PARAM_AGC_POIF_L	0x00
#define		PARAM_AGC_POIF_H	0x01
...
#define		PARAM_MACRO_PDOWN_DACPWDN_ON	0x03	/* Power-down */
...
#define		PARAM_VBERXRST_VBERXRSTB_E	0x02	/* B Layer BER End */
							/* VBERXRSTA */
#define		PARAM_VBERXRST_VBERXRSTA_E	0x00	/* A Layer BER End */
#define		PARAM_VBERXRST_VBERXRSTA_C	0x01	/* A Layer BER Continue */
...
//#define               PARAM_RS0_ERID_ON               0x04    /* ------ */
							/* RSEN */
#define		PARAM_RS0_RSEN_OFF		0x60	/* RS Enable Flag RS=OFF */
#define		PARAM_RS0_RSEN_ON		0x62	/* RS Enable Flag RS=ON  */
...
#define		PARAM_SBER2_SLAYER_A		0x01	/* A Layer */
							...
							/* TSERRINV */
#define		PARAM_TSOUT_TSERRINV_OFF	0x05	/* TSERR NON Invert Out */
#define		PARAM_TSOUT_TSERRINV_ON		0x85	/* TSERR Invert Out */
							/* TSENINV */
#define		PARAM_TSOUT_TSENINV_OFF		0x05	/* TSEN NON Invert Out */
#define		PARAM_TSOUT_TSENINV_ON		0x45	/* TSEN Invert Out */
							/* TSSINV */
#define		PARAM_TSOUT_TSSINV_MSB		0x05	/* Serial TS Out 0: MSB BEGIN */
#define		PARAM_TSOUT_TSSINV_LSB		0x25	/* Serial TS Out 1: LSB BEGIN */
							/* TSERRMASK2 */
#define		PARAM_TSOUT_TSERRMASK2_OFF	0x00	/* OFF : */
#define		PARAM_TSOUT_TSERRMASK2_ON	0x04	/* ON  : TSERR=0 Only */
							/* TSERRMASK2 */
#define		PARAM_TSOUT_TSERRMASK_OFF	0x05	/* OFF : */
#define		PARAM_TSOUT_TSERRMASK_ON	0x07	/* ON  : TSERR Replaced NULL data */
...
#define		PARAM_TMCC_IRQ_EMG		0x04	/* Emergency Interrupt */
#define		PARAM_TMCC_IRQ_CNT		0x02	/* TMCC count down Interrupt */
#define		PARAM_TMCC_IRQ_ILL		0x01	/* TMCC illegal parameter Interrupt */
...
#define		PARAM_SBER_IRQ_TSERRA			0x10
#define		PARAM_SBER_IRQ_SBERCEFCA		0x04	/* layer A RSBER count end Interrupt */
...
#define			PARAM_SEARCH_IRQ_GPIO2		0x40
#define			PARAM_SEARCH_IRQ_GPIO1		0x20
#define			PARAM_SEARCH_IRQ_GPIO0		0x10
#define			PARAM_SEARCH_IRQ_3WIRE_END	0x04
#define			PARAM_SEARCH_IRQ_CHSEL_END	0x02
#define			PARAM_SEARCH_IRQ_SEARCH		0x01

							/* TMCC_IRQ_MASK */
#define		PARAM_TMCC_IRQ_MASK_EMG		0x04	/* EMG mask */
#define		PARAM_TMCC_IRQ_MASK_CNTDOWN	0x02	/* CNTDOWN mask */
...
#define		PARAM_SBER_IRQ_MASK_CEMASKA	0x09	/* CEMASK A */
...
#define		PARAM_TMCC_IRQ_RST_CNTDOWN	0x02	/* CNTDOWN reset */
...
// -- long (2011/08/18) --
#define		PARAM_SEARCH_IRQCTL_3WIRE_RST	0x40
#define		PARAM_SEARCH_IRQCTL_CHSEL_RST	0x20
#define		PARAM_SEARCH_IRQCTL_IRQ_RST		0x10
#define		PARAM_SEARCH_IRQCTL_3WIRE_MASK	0x04
#define		PARAM_SEARCH_IRQCTL_CHSEL_MASK	0x02
#define		PARAM_SEARCH_IRQCTL_IRQ_MASK	0x01
...
#define		PARAM_SEARCH_END_END		0x01	/* Channel search complete flag */
							...
							/* STANDBY --long (2011/08/12)-- */
#define		PARAM_STANDBY_ON			0x00	/* STANDBY ON */
#define		PARAM_STANDBY_OFF			0x01	/* STANDBY OFF */
...
/* LNA_setting -- long (2011/08/12) -- */
struct ioctl_lna_setting {
	u8 LNA_SETTING;         /* LNA_SETTING  */
	//u8 LNA_GAIN_TH;
	//u8 LNA_GAIN_TH_L;
	//u8 LNA_GAIN_TH_H;
};
typedef struct ioctl_lna_setting ioctl_lna_setting_t;
...
struct ioctl_irq {
	u8 irq;
	u8 TMCC_IRQ; // -- long (2011/08/19) --
	u8 SBER_IRQ; // -- long (2011/08/19) --
	u8 SEARCH_IRQ; // -- long (2011/08/19) --
	u8 TMCC_IRQ_MASK;
	u8 SBER_IRQ_MASK;
	u8 TSERR_IRQ_MASK;
	u8 TMCC_IRQ_RST;
...
//	u8 PCHKOUT1;
	u8 EMG_INV;
	u8 SEARCH_IRQ_MASK; //-- long (2011/08/18) --
	u8 SEARCH_IRQ_RST; // -- long (2011/08/18) --
};
...
struct mer_data {
	...
	//u32 B;			/* layer B : measurement result area */ // unnecessary in A30V -- long (2011/08/19) --
	//u32 C;			/* layer C : measurement result area */ // unnecessary in A30V -- long (2011/08/19) --
};
...
/* High-Speed Channel Search control */
struct ioctl_ch_search {
	...
	u8 SEARCH_END;	
	u8 MODE_DETECT;	// -- long (2011/08/17) --
	u8 SEARCH_MODE;	// -- long (2011/08/17) --
	u8 SEARCH_GUARD;	// -- long (2011/08/17) --
	u8 SEARCH_TMCC;	// -- long (2011/08/17) --
	u8 PEAK_DETECT_NUM;	// -- long (2011/08/17) --
	u8 MODE_DETECT_NUM;	// -- long (2011/08/17) --
	u8 CH_DETECT_NUM;	// -- long (2011/08/17) --
	u8 CH_DETECT_OKNUM;	// -- long (2011/08/17) --
	u8 SEARCH_THRES;	// -- long (2011/08/17) --
	u8 SEARCH_TIME;	// -- long (2011/08/17) --
	u8 SEARCH_START_CH;	// -- long (2011/08/17) --
	u8 SEARCH_STOP_CH;	// -- long (2011/08/17) --
};
...
struct ioctl_rf {
	...
	u8 RF_INIT;		 // -- long (2011/08/17) --
};
typedef struct ioctl_rf ioctl_rf_t;

/* STANDBY -- long (2011/08/12) -- */
struct ioctl_standby {
	u8 mode;
};
typedef struct ioctl_standby ioctl_standby_t;
