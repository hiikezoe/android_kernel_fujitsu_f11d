...
static bool ena_media_key = true;
...
EXPORT_SYMBOL(report_chg_err_key);
static int qci_chg_err_key_ready = 0;
void qci_set_chg_err_key_ready(void)
{
     qci_chg_err_key_ready = 1;
}
int qci_get_chg_err_key_ready(void)
{
     return qci_chg_err_key_ready;
}
EXPORT_SYMBOL(qci_get_chg_err_key_ready);
#endif
...
static int __devinit hs_probe(struct platform_device *pdev)
{
	...
	input_set_capability(ipdev, EV_KEY, KEY_TEMP_MSM_OVER_LEYER_1);
       input_set_capability(ipdev, EV_KEY, KEY_TEMP_MSM_OVER_LEYER_2);
	input_set_capability(ipdev, EV_KEY, KEY_TEMP_MSM_OVER_LEYER_3);
	input_set_capability(ipdev, EV_KEY, KEY_TEMP_MSM_OVER_RESUME_NORMAL);
#endif
