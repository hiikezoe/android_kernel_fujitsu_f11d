...
#if defined(T_QCI_IS3) && defined(CONFIG_I2C_GPIO)
...
#if defined(T_QCI_IS3) && defined(CONFIG_I2C_GPIO)
static struct i2c_gpio_platform_data is3_gpio_i2c = {
	.sda_pin 		= 2,
	.scl_pin 		= 3,
	.udelay 		= 1,
...
struct platform_device is3_i2cGpio_device = {
	.name = "i2c-gpio",
	.id = 8,
	.dev = {
		.platform_data = &is3_gpio_i2c,
	},
};
#endif
