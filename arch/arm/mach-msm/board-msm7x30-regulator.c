...
static struct proccomm_regulator_info msm7x30_pcom_vreg_info[] = {
	...
	PCOM_VREG_LDO(ldo10,  7, NULL,  2850000,  2850000, 0, -1, 0, 0, 0, 0),
#else
...
#if defined(T_QCI_IS3)
	PCOM_VREG_LDO(ldo16, 35, NULL,  3000000,  3000000, 0, -1, 0, 0, 0, 0),
#else
...
#if defined(T_QCI_IS3)
	PCOM_VREG_LDO(ldo22, 40, NULL,  1100000,  1300000, 0, -1, 0, 0, 0, 0),
#else
